...
#            print('ROUTE: r%i_%i' % (i+1, it+2))
            path[(i+1)], r_cost[(i+1)], cost[(i+1)], times[(it+1, i+1)] = sub_problem2(n_customers, i, n_vehicles, n_extra_customers, extra_dict[i], arr_times[i], starting_times, pi, gamma, t, T, Q_max, err_penalty)
#            print(path[(i+1)])
#            print(r_cost[(i+1)])
#            print(cost[(i+1)])
#            
